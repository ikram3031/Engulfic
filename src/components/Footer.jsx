...
export default function Footer() {
  ...
  return (
    <footer className="hidden md:block bg-slate-900 dark:bg-[#050505]/80 backdrop-blur-xl text-white border-t border-slate-800 dark:border-white/10 pt-16 pb-12 relative z-10 transition-colors duration-300">
