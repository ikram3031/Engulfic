...
const baseURL = import.meta.env?.VITE_API_BASE_URL || process.env.NEXT_PUBLIC_API_BASE_URL || 'https://service.decantrebd.com';
...
// Request Interceptor: Attach Bearer Token if available & handle FormData Content-Type
apiClient.interceptors.request.use((config) => {
  ...
  // Handle FormData: Remove default application/json Content-Type so Axios/browser sets boundary automatically
