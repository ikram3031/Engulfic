  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (mainImageFile) {
        ...
        finalMainImageUrl = uploadRes.data?.data?.imageUrl || uploadRes.data?.data?.url || uploadRes.data?.imageUrl || uploadRes.data?.url || "";
      }
      ...
      for (let i = 0; i < validVariants.length; i++) {
        ...
        if (v.imageFile) {
          ...
          varImageUrl = uploadRes.data?.data?.imageUrl || uploadRes.data?.data?.url || uploadRes.data?.imageUrl || uploadRes.data?.url || "";
        }
